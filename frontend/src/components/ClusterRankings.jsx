    ...
    <Panel
      ...
      subtitle={
        <div className="flex flex-wrap items-center gap-1.5 mt-1 text-xs text-muted">
          <span>ranked by priority · severity:</span>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2.5 text-sm text-muted mt-2">
                  <span className="font-medium text-brand">{c.category}</span>
